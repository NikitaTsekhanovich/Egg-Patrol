...
{
    public class FourthSpawnState : SpawnState
    {
        private readonly SpawnerStateMachine _spawnerStateMachine;
        
        public FourthSpawnState(
                ...
                scoreHandler)
        {
            ...
            SpawnConfig = runTimeGameData.FourthSpawnConfig;
        }

        protected override void EndSpawnWave()
        {
            _spawnerStateMachine.EnterIn<FifthSpawnState>();
        }
    }
}
