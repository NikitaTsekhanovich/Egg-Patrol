...
{
    public class SecondSpawnState : SpawnState
    {
        private readonly SpawnerStateMachine _spawnerStateMachine;
        
        public SecondSpawnState(
                ...
                scoreHandler)
        {
            ...
            SpawnConfig = runTimeGameData.SecondSpawnConfig;
        }

        protected override void EndSpawnWave()
        {
            _spawnerStateMachine.EnterIn<ThirdSpawnState>();
        }
    }
}
